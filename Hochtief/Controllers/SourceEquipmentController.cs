...
namespace HomeProject.Controllers
{
    public class SourceEquipmentController : Controller
    {
        ...
        public ActionResult Create(SourceEquipment test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, SourceEquipment test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(int id, SourceEquipment test)
        {
            try
            {
