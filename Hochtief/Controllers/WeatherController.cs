...
namespace Hochtief.Controllers
{
    ...
    {
        private readonly IRepostory<Weather> testRepostory;

        public WeatherController(IRepostory<Weather> TestRepostory)
        {
        ...
        public ActionResult Create(Weather test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Weather test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(int id, Weather test)
        {
            try
            {
