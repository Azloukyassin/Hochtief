...
namespace Hochtief.Controllers
{
    ...
    {
        private readonly IRepostory<Schedule> testRepostory;

        public ScheduleController(IRepostory<Schedule> TestRepostory)
        {
        ...
        public ActionResult Create(Schedule test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Schedule test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(int id, Schedule test)
        {
            try
            {
