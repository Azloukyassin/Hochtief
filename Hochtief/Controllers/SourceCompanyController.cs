...
namespace Hochtief.Controllers
{
    ...
    {
        private readonly IRepostory<SourceCompany> testRepostory;

        public SourceCompanyController(IRepostory<SourceCompany> TestRepostory)
        {
        ...
        public ActionResult Create(SourceCompany test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, SourceCompany test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(int id, SourceCompany test)
        {
            try
            {
