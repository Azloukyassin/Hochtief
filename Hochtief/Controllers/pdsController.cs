...
namespace Hochtief.Controllers
{
    ...
    {
        private readonly IRepostory<Pds> testRepostory;

        public pdsController(IRepostory<Pds> TestRepostory)
        {
        ...
        public ActionResult Create(Pds test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Pds test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(int id, Pds test)
        {
            try
            {
