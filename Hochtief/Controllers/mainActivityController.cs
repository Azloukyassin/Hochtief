...
namespace Hochtief.Controllers
{
    ...
    {
        private readonly IRepostory<MainActivity> testRepostory;

        public mainActivityController(IRepostory<MainActivity> TestRepostory)
        {
        ...
        public ActionResult Create(MainActivity test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, MainActivity test)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(int id, MainActivity test)
        {
            try
            {
